...
mkdir $DIRNAME
cd $DIRNAME
curl -O http://www.ring.gr.jp/pub/text/CTAN/systems/texlive/tlnet/install-tl.zip
...
binary_win32 1
EOF
echo y | ./install-tl-windows.bat -profile ./fullinst.profile -repository http://www.ring.gr.jp/pub/text/CTAN/systems/texlive/tlnet/
